  ...
  describe 'Create new user' do
    ...
    context 'have no name, email and password' do
      it 'show errors message' do
        ...
        expect(errors_message).to eq(name: ["can't be blank"], email: ["can't be blank", 'is invalid'], password: ["can't be blank", 'is too short (minimum is 6 characters)', "can't be blank"])
      end
    end
  end
end
